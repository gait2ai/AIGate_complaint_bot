...
class PromptBuilder:
    ...
    def _validate_placeholder_replacement(self, template: str, variables: dict) -> bool:
        ...
        missing_vars = [p for p in placeholders if p not in variables]
    ...
    def _safe_format_template(self, template: str, variables: dict) -> str:
        ...
        try:
            if not self._validate_placeholder_replacement(template, variables):
            ...
            if remaining:
                logger.warning(f"Unformatted placeholders: {remaining}")
