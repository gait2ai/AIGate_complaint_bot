...
DEFAULT_MESSAGES: Dict[str, Dict[str, str]] = {
    'ar': {
        ...
        'invalid_nationality': "❌ يرجى إدخال جنسيتك كنص.",
        ...
        'prompt_select_disability': "هل لديك أي إعاقة؟",
        ...
        'validation_error_age': "❌ العمر المدخل غير صالح. يرجى إدخال رقم صحيح.",
        'validation_error_nationality': "❌ يرجى إدخال جنسيتك كنص.",
        ...
        'processing_submission_critical': "⏳ جاري معالجة شكواك العاجلة، يرجى الانتظار...",
        'btn_yes_disability': "نعم",
        'btn_no_disability': "لا",
        ...
        'btn_exit': "🚪 خروج",
        # Export messages
        'admin_export_prompt': "الرجاء تحديد البيانات التي ترغب في تصديرها:",
        'export_option_complaints': "📊 تصدير الشكاوى",
        'export_option_beneficiaries': "👥 تصدير المستفيدين",
        'export_option_notes': "📝 تصدير الملاحظات/التذكيرات",
        'admin_export_loading': "⏳ جاري إنشاء ملف التصدير، يرجى الانتظار...",
        'admin_export_success': "✅ تمت عملية تصدير البيانات بنجاح. الملف: {filename}",
        'admin_export_success_short': "✅ تم التصدير بنجاح. تم إرسال الملف إليك.",
        'admin_export_no_data': "ℹ️ لا توجد بيانات متاحة للتصدير.",
        'admin_export_failed': "❌ حدث خطأ أثناء إنشاء ملف التصدير.",
        ...
        'prompt_enter_nationality': "يرجى إدخال جنسيتك:",
        ...
        'critical_confirm_submission_prompt': "شكرًا لك. لتقديم شكواك العاجلة الآن، يرجى الضغط على تأكيد. سيتم إرسالها فورًا إلى الفريق المختص.",
    ...
    'en': {
        ...
        'invalid_nationality': "❌ Please enter your nationality as text.",
        ...
        'prompt_select_disability': "Do you have any disability?",
        ...
        'validation_error_age': "❌ Invalid age entered. Please enter a valid number.",
        'validation_error_nationality': "❌ Please enter your nationality as text.",
        ...
        'processing_submission_critical': "⏳ Processing your urgent complaint, please wait...",
        'btn_yes_disability': "Yes",
        'btn_no_disability': "No",
        ...
        'btn_exit': "🚪 Exit",
        # Export messages
        'admin_export_prompt': "Please select the data you wish to export:",
        'export_option_complaints': "📊 Export Complaints",
        'export_option_beneficiaries': "👥 Export Beneficiaries",
        'export_option_notes': "📝 Export Notes/Reminders",
        'admin_export_loading': "⏳ Generating export file, please wait...",
        'admin_export_success': "✅ Data export complete. File: {filename}",
        'admin_export_success_short': "✅ Export successful. The file has been sent to you.",
        'admin_export_no_data': "ℹ️ No data available to export.",
        'admin_export_failed': "❌ An error occurred while generating the export file.",
        ...
        'prompt_enter_nationality': "Please enter your nationality:",
        ...
        'critical_confirm_submission_prompt': "Thank you. To submit your urgent complaint now, please press Confirm. It will be sent immediately to the specialized team.",
...
# --- NEW FUNCTION FOR CONVERSATION LOGGING ---
def log_conversation_state_change(user_id: int, action: str, state_value: int = None, state_name: str = None):
    """
    Log conversation state changes for debugging.
    Provides a clear trace of a user's journey through a conversation.
    """
    if state_value is not None and state_name:
        logger.info(f"[CONVO_TRACE] User {user_id} - Action: {action} - State: {state_name}({state_value})")
    else:
        logger.info(f"[CONVO_TRACE] User {user_id} - Action: {action}")
        
def get_disability_keyboard(bot_instance: 'InstitutionBot', is_arabic: bool) -> InlineKeyboardMarkup:
    """Creates an inline keyboard for disability selection."""
    keyboard = [
        [
            InlineKeyboardButton(
                text=get_message('btn_yes_disability', bot_instance, is_arabic),
                callback_data="disability:yes"
            ),
            InlineKeyboardButton(
                text=get_message('btn_no_disability', bot_instance, is_arabic),
                callback_data="disability:no"
            )
        ]
    ]
    return InlineKeyboardMarkup(keyboard)