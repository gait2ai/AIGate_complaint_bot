...
This module contains handler functions for standard bot commands (/help, /contact)
...
- Shared conversation cancellation mechanism
...
def register_common_commands(application) -> None:
    ...
    This function adds the standard command handlers (/help, /contact) to the
