...
def get_main_conversation_handler():
    ...
    return ConversationHandler(
        ...
        entry_points=[
            ...
            # This ensures users can initiate conversations with any text message
        ...
        states={
            ...
            COLLECTING_SEX: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, process_sex)
            ],
            ...
            COLLECTING_RESIDENCE: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, process_residence_status)
            ],
            
            COLLECTING_GOVERNORATE: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, process_governorate)
            ],
