...
Core Philosophy:
- A single unified entry point for all user-initiated conversation flows.
...
def get_main_conversation_handler():
    ...
    return ConversationHandler(
        ...
        entry_points=[
            ...
            # This single handler intelligently processes all conversation initiations
            MessageHandler(filters.TEXT & ~filters.COMMAND, handle_unified_entry_point)
        ],
