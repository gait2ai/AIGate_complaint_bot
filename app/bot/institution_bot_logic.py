...
class InstitutionBot:
    ...
    async def _log_complaint(self, data: ComplaintData) -> Optional[str]:
        ...
        try:
            ...
            # Insert complaint into database (without reference_id initially)
            self.db_manager.execute_query(
            ...
            numeric_id_result = self.db_manager.fetch_one("SELECT last_insert_rowid()")
            ...
            # Save the reference ID back to the database
            self.db_manager.execute_query(
