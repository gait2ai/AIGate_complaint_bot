...
async def initialize_institution_bot(
    ...
    try:
        ...
        logging.info("InstitutionBot initialized successfully with AppConfig integration and v20+ persistence")
...
async def run_application():
    ...
    7. InstitutionBot Initialization (using full AppConfig with v20+ persistence)
    ...
    try:
        ...
        logging.info("Step 5/8: Initializing AIHandler with dictionary from Pydantic AiModelsModel...")
        ai_handler_instance = await initialize_ai_handler(config, cache_manager_instance)
        
        # Step 7: Initialize InstitutionBot with full AppConfig and v20+ persistence
        logging.info("Step 6/8: Initializing InstitutionBot with complete AppConfig and v20+ persistence...")
